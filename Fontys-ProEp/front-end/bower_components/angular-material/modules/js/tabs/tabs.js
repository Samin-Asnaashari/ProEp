...
function MdTabsController ($scope, $element, $window, $mdConstant, $mdTabInkRipple,
  ...
  /**
   * Slides the tabs over approximately one home forward.
   */
  function nextPage () {
    var elements = getElements();
  ...
  /**
   * Slides the tabs over approximately one home backward.
   */
 ...
 *
 * <i><b>Note:</b> If you are using the Tabs component for home-level navigation, please take a look
