 ...
 * for top-level home navigation. Unlike `<md-tabs>`, it has no concept of a tab
 * body and no bar pagination.
 *
 * Because it deals with home navigation, certain routing concepts are built-in.
 ...
 *
 * @description
 * `<md-nav-item>` describes a home navigation link within the `<md-nav-bar>`
 ...
 * link is clicked to change the home. Renders as an `ng-click`.
