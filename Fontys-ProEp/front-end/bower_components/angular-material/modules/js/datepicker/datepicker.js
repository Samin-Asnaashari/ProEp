...
(function() {
  ...
  // TODO(jelbourn): Support md-calendar standalone on a home (as a tabstop w/ aria-live
  ...
  CalendarCtrl.prototype.getActionFromKeyEvent = function(event) {
    ...
    switch (event.which) {
      ...
      case keyCode.DOWN_ARROW: return event.metaKey ? 'move-home-down' : 'move-row-down';
      case keyCode.UP_ARROW: return event.metaKey ? 'move-home-up' : 'move-row-up';

      case keyCode.PAGE_DOWN: return 'move-home-down';
      case keyCode.PAGE_UP: return 'move-home-up';
   ...
   * than a home of content (e.g. a month or year view has a min or max date).
   */
  ...
  CalendarMonthCtrl.prototype.handleKeyEvent = function(event, action) {
    ...
    if (action === 'select') {
      ...
      switch (action) {
        ...
        case 'move-home-down': date = dateUtil.incrementMonths(displayDate, 1); break;
        case 'move-home-up': date = dateUtil.incrementMonths(displayDate, -1); break;
