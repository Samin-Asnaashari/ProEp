 ...
 *     with the rest of the home until the panel is dismissed. Defaults to
 *     false.
 ...
 *     home behind the panel. Defaults to false.
 ...
 * @description
 * Sets the panel to the start of the home - `left` if `ltr` or `right` for
 ...
 * @description
 * Sets the panel to the end of the home - `right` if `ltr` or `left` for `rtl`.
 ...
 * @param {string} position Horizontal position of the panel
 * @returns {string} The correct position according the home direction
 * @private
 */
