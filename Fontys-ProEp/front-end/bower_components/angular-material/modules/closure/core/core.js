 ...
 * `$mdBottomSheet`, `$mdMenu` or `$mdSidenav` opens or upon home load for input-like elements.
 *
 ...
 * there are multiple material apps on the same home, each app
...
function UtilFactory($document, $timeout, $compile, $rootScope, $$mdAnimate, $interpolate, $log, $rootElement, $window, $$rAF) {
  ...
  var $mdUtil = {
    ...
    clientRect: function(element, offsetParent, isOffsetRect) {
      ...
      // or a clientRect: a rect relative to the home
 ...
 * Tags that are only processed when the home is rendered (such as `charset`, and `http-equiv`)
 * will not work since `$$mdMeta` adds the tags after the home has already been loaded.
 *
 * ```js
